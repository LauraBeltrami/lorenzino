...
public class AcquirenteCarrelloController {
    ...
    @PostMapping("/items") public CarrelloDTO addItem(@PathVariable Long acquirenteId, @Valid @RequestBody AddItemReq req) {
    ...
    @PostMapping("/bundles") public CarrelloDTO addBundle(@PathVariable Long acquirenteId, @Valid @RequestBody AddBundleReq req) {
